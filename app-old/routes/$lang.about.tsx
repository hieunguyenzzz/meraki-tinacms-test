    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img 
                ...
                alt={lang === "en" ? "Our team at work" : "Đội ngũ của chúng tôi đang làm việc"}
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-light text-gray-900 mb-4">
              {lang === "en" ? "Our Approach" : "Cách tiếp cận của chúng tôi"}
            </h2>
          </div>
          ...
          <div className="space-y-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="md:order-1">
                <h3 className="text-2xl font-medium text-gray-900 mb-4">
                  {lang === "en" ? "Listen & Understand" : "Lắng nghe & Hiểu"}
                </h3>
                <p className="text-gray-600">
                  {lang === "en" 
                    ? "We start by getting to know you as a couple - your story, your dreams, your style, and your budget. This foundation allows us to create a wedding that truly reflects who you are."
                    : "Chúng tôi bắt đầu bằng việc tìm hiểu bạn như một cặp đôi - câu chuyện của bạn, ước mơ, phong cách và ngân sách. Nền tảng này cho phép chúng tôi tạo ra một đám cưới thực sự phản ánh con người bạn."
                  }
                </p>
              </div>
              <div className="md:order-2">
                <div className="w-full h-64 bg-gray-200 rounded-lg flex items-center justify-center">
                  <span className="text-gray-500">
                    {lang === "en" ? "Consultation Image" : "Hình ảnh tư vấn"}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <div className="w-full h-64 bg-gray-200 rounded-lg flex items-center justify-center">
                  <span className="text-gray-500">
                    {lang === "en" ? "Planning Image" : "Hình ảnh lên kế hoạch"}
                  </span>
                </div>
              </div>
              <div>
                <h3 className="text-2xl font-medium text-gray-900 mb-4">
                  {lang === "en" ? "Plan & Create" : "Lên kế hoạch & Tạo ra"}
                </h3>
                <p className="text-gray-600">
                  {lang === "en" 
                    ? "With a clear vision in mind, we meticulously plan every detail - from venue selection and design concepts to vendor coordination and timeline management."
                    : "Với tầm nhìn rõ ràng trong đầu, chúng tôi lên kế hoạch tỉ mỉ từng chi tiết - từ việc chọn địa điểm và ý tưởng thiết kế đến điều phối nhà cung cấp và quản lý thời gian."
                  }
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="md:order-1">
                <h3 className="text-2xl font-medium text-gray-900 mb-4">
                  {lang === "en" ? "Execute & Celebrate" : "Thực hiện & Tôn vinh"}
                </h3>
                <p className="text-gray-600">
                  {lang === "en" 
                    ? "On your wedding day, we ensure everything runs seamlessly so you can focus on what matters most - celebrating your love with family and friends."
                    : "Trong ngày cưới của bạn, chúng tôi đảm bảo mọi thứ diễn ra suôn sẻ để bạn có thể tập trung vào điều quan trọng nhất - tôn vinh tình yêu với gia đình và bạn bè."
                  }
                </p>
              </div>
              <div className="md:order-2">
                <div className="w-full h-64 bg-gray-200 rounded-lg flex items-center justify-center">
                  <span className="text-gray-500">
                    {lang === "en" ? "Wedding Day Image" : "Hình ảnh ngày cưới"}
                  </span>
                </div>
              </div>
            </div>
