    ...
    return {
      ...
      description:
        lang === 'en'
          ...
          : 'Cái nhìn sâu sắc và mẹo lập kế hoạch đám cưới',
    };
  }
}
...
export default async function BlogPostPage({ params }: Props) {
  ...
  try {
    ...
    console.log(JSON.stringify(blogPost.body.children));
  ...
  const title = lang === 'en' ? blogPost.title_en : blogPost.title_vi;
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
          <nav className='flex' aria-label='Breadcrumb'>
            <ol className='flex items-center space-x-4'>
              ...
              <li className='text-gray-900 truncate'>{title}</li>
            </ol>
          </nav>
        </div>
      </div>
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
          <header className='mb-8'>
            ...
            <div className='flex items-center text-gray-600 text-sm mb-6'>
              <time dateTime={blogPost.published_date}>{publishedDate}</time>
              <span className='mx-2'>•</span>
              <span>
                {t({
                  en: 'Wedding Planning Tips',
                  vi: 'Mẹo lập kế hoạch cưới',
                })}
              </span>
            </div>
