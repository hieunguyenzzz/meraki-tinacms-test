...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  try {
    ...
    return {
      ...
      description: seo?.description || (lang === "en" ? "Professional wedding planning services in Vietnam" : "Dịch vụ tổ chức tiệc cưới chuyên nghiệp tại Việt Nam"),
      openGraph: {
        title: seo?.title || (lang === "en" ? "Meraki Wedding Planner" : "Meraki Wedding Planner"),
        description: seo?.description || (lang === "en" ? "Professional wedding planning services in Vietnam" : "Dịch vụ tổ chức tiệc cưới chuyên nghiệp tại Việt Nam"),
        type: "website",
    ...
    return {
      title: lang === "en" ? "Meraki Wedding Planner" : "Meraki Wedding Planner",
      description: lang === "en" ? "Professional wedding planning services in Vietnam" : "Dịch vụ tổ chức tiệc cưới chuyên nghiệp tại Việt Nam",
    };
  }
}
